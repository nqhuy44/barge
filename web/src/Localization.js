const resources = {
  en: {
    ...
    menu: {
      ...
      error_code_invalid: "Room code must be 6 digits!",
    },
    lobby: {
      room_label: "Room",
    ...
    game: {
      ...
      death_countdown: "Respawn in",
      game_over_title: "VICTORY!",
      final_leaderboard: "FINAL LEADERBOARD",
      back_to_lobby: "BACK TO MENU ▶",
      kills: "Kills",
      controls_move: "Move",
      controls_charge: "Charge",
      player_you: "(You)",
      feed_shoved: "shoved",
      feed_suicided: "fell off",
    },
  },
  vi: {
    common: {
    ...
    menu: {
      ...
      error_name_empty: "Vui lòng nhập tên của bạn!",
      error_code_invalid: "Mã phòng phải có 6 chữ số!",
    },
    lobby: {
      room_label: "Phòng",
    ...
    game: {
      ...
      death_title: "BỊ HÚC VĂNG!",
      death_countdown: "Hồi sinh trong",
      game_over_title: "CHIẾN THẮNG!",
      final_leaderboard: "BẢNG XẾP HẠNG CUỐI CÙNG",
      back_to_lobby: "VỀ TRANG CHỦ ▶",
      kills: "Mạng",
      controls_move: "Di chuyển",
      controls_charge: "Húc",
      player_you: "(Bạn)",
      feed_shoved: "đã húc bay",
      feed_suicided: "tự hủy",
    },
  },
};
